pipeline {
    ...
    parameters {
        ...
        string(name: 'STUDENT_NAME', defaultValue: 'Hassan Qureshi', description: 'Provide your name (required for marks)')
    ...
    post {
        ...
        success {
            echo "✅ Pipeline succeeded! Version ${APP_VERSION} built and tested successfully by ${params.STUDENT_NAME}."
        }
        failure {
